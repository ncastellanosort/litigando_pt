...
### Tambien se podria leer solo linea por linea sin guardar en memoria, hay un problema y es que lo que es el allData que guarda el reader esta en memoria, llegara un punto en el que el CSV sea tan grande que la memoria se agote,
### por lo que en vez de guardarlos, se podria solo leerlas sin guardarlas para realizar las operaciones.
